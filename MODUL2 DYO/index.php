...
<body>
    <div class="row">
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4" align="center">Kalkulator BMI</h4>
                    <h6 class="card-title mb-4" align="center">Alat untuk menghitung Indeks Massa Tubuh kamu!</h6>
                    ...
                    <?php
                    if(isset($bmi)) {
                        echo "<h5>Hasil Perhitungan BMI</h5>";
